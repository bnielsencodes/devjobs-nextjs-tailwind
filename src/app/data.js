...
export default [
  {
    ...
    name: "Scoot",
    logo: scootLogo,
    brandColor: "hsl(36, 87%, 49%)",
    position: "Senior Software Engineer",
    timestamp: "5h ago",
    contract: "Full Time",
    location: "United Kingdom",
    websiteUrl: "https://example.com/scoot",
    applyUrl: "https://example.com/scoot/applyUrl",
    description:
    ...
    role: {
      text: "We are looking for a Senior Software Engineer to join as one of our first hires. As we iterate on our MVP, you will have the opportunity to drive the vision and own the build behind our digital experience. You’ll have the support of an experienced technical advisor, a Head of Product, and an external team to work with.",
      list: [
  ...
  },
  {
    ...
    requirements: {
      text: "We are looking to carefully add great developers which care about solving problems & which have been in a relationship with Purescript and/or Haskell for at least 3 years (Not necessarily monogamous though).",
      list: [
    ...
    role: {
      text: "The role is more frontend-focused where you will be tasked to build browser-based UIs for Haskell applications.",
      list: [
  ...
  },
  {
    ...
    role: {
      text: "This is an IDEAL job if you already have a few years of software engineering experience under your belt, and you want to be part of a small, intensely skilled team, who feel total ownership of their work, and can’t imagine a day without learning & coding. You will play a crucial role in the Vector platform and everything you do will matter.",
      list: [
  ...
  },
  {
    ...
    name: "Pod",
    logo: podLogo,
    brandColor: "hsl(216, 46%, 14%)",
    position: "Remote DevOps Engineer",
    timestamp: "2d ago",
    contract: "Part Time",
    location: "Japan",
    websiteUrl: "https://example.com/pod",
    applyUrl: "https://example.com/pod/applyUrl",
    description:
    ...
    requirements: {
      text: "We are looking for talented and motivated engineers who can hit the ground running and take our products to the next level. The engineers who are building our platform across the stack are always willing to go the extra mile to deliver the highest quality software and client experiences. Ideally, you would have:",
      list: [
  ...
  },
  {
    ...
    requirements: {
      text: "You are likely someone with a solid background in end-user support and troubleshooting, as this position involves dealing with a large, and often changing, number of day-to-day issues which arise in supporting the information technology requirements of our applications.",
      list: [
    ...
    role: {
      text: "This is an 80% management and 20% hands-on supervisory role where you will be responsible for the support of automation technologies and managing a team of support engineers in a 24x7 high-volume environment.",
      list: [
  ...
  },
  {
    ...
    name: "Pomodoro",
    logo: pomodoroLogo,
    brandColor: "hsl(254, 71%, 45%)",
    position: "iOS Engineer",
    timestamp: "1w ago",
    contract: "Full Time",
    location: "United States",
    websiteUrl: "https://example.com/pomodoro",
    applyUrl: "https://example.com/pomodoro/applyUrl",
    description:
    ...
    requirements: {
      text: "You are an experienced mobile engineer looking to make Pomodoro one of the best mobile experiences out there. You are someone who excels at customer-centric product development and has a passion for working on application architecture and design, and making smooth, delightful experiences. You care deeply about quality, are energized by partnership and collaboration, and you strive to enable others around you to excel.",
      list: [
  ...
  },
  {
    ...
    name: "Maker",
    logo: makerLogo,
    brandColor: "hsl(218, 58%, 31%)",
    position: "Senior EJB Developer",
    timestamp: "1w ago",
    contract: "Full Time",
    location: "United Kingdom",
    websiteUrl: "https://example.com/maker",
    applyUrl: "https://example.com/maker/applyUrl",
    description:
    ...
    requirements: {
      text: "The candidate must have work experience in all aspects of designing and constructing J2EE/EJB systems and developing system requirements and design specifications, and J2EE/EJB Coding for new and existing applications.",
      list: [
    ...
    role: {
      text: "Job responsibilities will include developing scalable Java applications while providing expertise in the full software development lifecycle, from concept and design to testing.",
      list: [
  ...
  },
  {
    ...
    brandColor: "hsl(29, 60%, 87%)",
    position: "Senior Frontend Developer",
    timestamp: "1w ago",
    contract: "Part Time",
    location: "Singapore",
    websiteUrl: "https://example.com/coffeeroasters",
    applyUrl: "https://example.com/coffeeroasters/applyUrl",
    description:
    ...
    role: {
      text: "Beyond working closely with our team to build an exciting app, you’ll be leading Frontend development of our React/Next.js product. You’ll be coming up with UI/UX for the app and making architectural decisions for the frontend.",
      list: [
  ...
  },
  {
    ...
    brandColor: "hsl(0, 0%, 12%)",
    position: "App & websiteUrl Designer",
    timestamp: "2w ago",
    contract: "Freelance",
    location: "United States",
    websiteUrl: "https://example.com/mastercraft",
    applyUrl: "https://example.com/mastercraft/applyUrl",
    description:
    ...
    requirements: {
      text: "To be successful in this role, you should have experience with design software and wireframe tools preferably Figma. You should also have a portfolio of professional design projects that includes work with web/mobile applications.",
      list: [
    ...
    role: {
      text: "You’ll create both functional and appealing features that address our clients’ needs and help us grow our customer base. We expect you to have experience with market/user research and stay current with most recent trends, tools, workflows.",
      list: [
  ...
  },
  {
    ...
    name: "Crowdfund",
    logo: crowdfundLogo,
    brandColor: "hsl(157, 57%, 50%)",
    position: "Fullstack Developer",
    timestamp: "1mo ago",
    contract: "Part Time",
    location: "New Zealand",
    websiteUrl: "https://example.com/crowdfund",
    applyUrl: "https://example.com/crowdfund/applyUrl",
    description:
      "Crowdfund is currently expanding and working on revolutionizing the world of raising funds for any project – creative, entrepreneurial or cause-related. Come and join us in this growth! We are looking for an exceptionally talented Fullstack Developer who will become an integral part of the name’s exciting new chapter.",
    requirements: {
      text: "We'd love to hear from you if you take ownership of your work and continuously want to improve the products you've built. We're looking for developers who have an uncanny abilithy to work very well cross-functionality in a flat startup.",
      list: [
  ...
  },
  {
    ...
    role: {
      ...
      list: [
        ...
        "applyUrl user experience methodology and best practices to translate user needs and business requirements into engaging user-centered design.",
  ...
  },
  {
    ...
    requirements: {
      text: "You will be responsible for writing and debugging your code while writing your own unit tests. We are looking for self-motivated developers who are interested in learning and can quickly pick up new technologies. We’re a relatively small team in a stable yet fast growing name and would love for you to join us.",
      list: [
        "Experience in JavaScript software development, preferably in a product name",
    ...
    role: {
      text: "In this role, you are part of our Product team comprised of Frontend & Backend Developers, UX & UI Specialists and Product Owners. You'll work on mission critical projects from the first day on, support other engineers, share your knowledge with your colleagues, and contribute to agile projects.",
      list: [
